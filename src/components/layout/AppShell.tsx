...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-navy-950 text-beige-200">
      <header className="border-b border-charcoal-700 bg-navy-900 px-3 py-2 flex flex-col gap-2">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-beige-400 font-mono">
              {state.unitName} &middot; {CHAPTER_TITLES[state.chapter]} &middot; Day {state.day}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <button
              className="p-1.5 rounded border border-charcoal-600 hover:bg-charcoal-700 transition-colors"
            ...
            <button
              className="p-1.5 rounded border border-charcoal-600 hover:bg-muted-redDark transition-colors"
