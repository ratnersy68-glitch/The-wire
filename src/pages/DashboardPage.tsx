    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        {state.officers.map((o) => (
          <div key={o.id} className={`panel p-3 ${o.available ? '' : '!border-muted-redDark opacity-60'}`}>
            ...
            <div className="section-label mb-0.5">Today's Assignment</div>
      ...
      {state.chapter >= 5 && (
        <div className="mt-6 panel !border-muted-red bg-muted-redDark/10">
          ...
          <div className="grid md:grid-cols-2 gap-1 mb-3 max-h-48 overflow-y-auto">
            {knownSuspects.map((s) => (
              <label key={s.id} className="flex items-center gap-2 text-xs px-2 py-1 rounded hover:bg-white/5">
